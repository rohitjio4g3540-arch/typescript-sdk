...
describe('inputRequired() builder', () => {
    ...
    test('per-kind constructors produce the embedded request shapes', () => {
        expect(inputRequired.elicitUrl({ message: 'go', elicitationId: 'e1', url: 'https://example.com/auth' })).toEqual({
            method: 'elicitation/create',
            params: { mode: 'url', message: 'go', elicitationId: 'e1', url: 'https://example.com/auth' }
        });
